...
const Navbar = () => {
    ...
    const handleNavClick = (type) => {
        switch (type) {
            case 'finder': // "Projects" button
                setActiveLocation(locations.work); // Set location to Work/Projects
                openWindow('finder'); // Open Finder
                break;
            case 'experience': // "Experience" button
                setActiveLocation(locations.experience); // Set location to Experience
                openWindow('finder'); // Open Finder
                break;
            case 'contact':
                openWindow('contact');
